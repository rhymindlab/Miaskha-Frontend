...
export default function ProductDetails({formData, metalData, product}){
  const {selectedMaterialNotNormalize: selectedMaterial, selectedPurity} = pricedetails(formData, metalData, product);
    return (
  ...
  <div className="bg-gray-50">
    ...
    <div className="px-6 flex">
      ...
      <div className=" flex mr-20 flex-col  py-4 ">
        ...
        <span className="text-gray-500">{selectedPurity}</span>
      </div>
      ...
      <div className=" flex mr-20 flex-col py-4 ">
        ...
        <div>
          ...
          <span className="text-gray-500">{product?.productWeight || 0} g</span>
        </div>
        <div>
          <span className=" mr-2">Net(Metal):</span>
          <span className="text-gray-500">{product?.metalWeight || 0} g</span>
        </div>
      </div>
    ...
    <div className="">
      <PriceBreakup formData={formData} metalData={metalData} product={product} /> 
    </div>
